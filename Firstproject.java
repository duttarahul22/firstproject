...
public class Firstproject {
	...
	public static void main(String[] args) {
		...
		char ch;
		File directory = new
		File("C://Users//LENOVO//Desktop//simplilearn//FileCreation");
		...
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
		System.out.println("@@@@@@@@@   RAHUL DUTTA   @@@@@@@@@@@@@@@");
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
		...
		try {
		File file = new
		File("C:\\Users\\Public\\Simplilearn\\" + filename + ".txt");
		...
		File("C:\\Users\\Public\\Simplilearn");
		...
		File file = new File("C:\\Users\\Public\\Simplilearn\\" + delete_filename);
		if (file.delete()) {
		...
		filename = input.next();
		File directory_search = new File("C:\\Users\\Public\\Simplilearn\\");
	   ...
	   File folder = new File("C:\\Users\\Public\\Simplilearn\\");
